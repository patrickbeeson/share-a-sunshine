...
$(document).ready(function(){$('.prefilled_message button').click(function(){ var prefilled_message=$(this).parent().find('.message').text(); var custom_message=$('#personal_message') 
